...
export default function Deals(){
    ...
    return(
        <div className="dealsContainer">
            ...
            <div className="deals">
            <div className="deal">
                <img src={banner} alt="Calgary deep dish pizza deal number 1" className="dealImg" />
            ...
            <div className="deal">
                <img src={banner} alt="Calgary deep dish pizza deal number 3" className="dealImg" />
                <div className="dealContent">
            ...
            <div className="deal">
                <img src={banner} alt="Calgary deep dish pizza deal number 5" className="dealImg" />
                <div className="dealContent">
            ...
            <div className="deal">
                <img src={banner} alt="Calgary deep dish pizza deal number 6" className="dealImg" />
                <div className="dealContent">
