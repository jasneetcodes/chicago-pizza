...
export default function Deals(){
    ...
    return(
        <div className="dealsContainer">
            ...
            <div className="deals">
            <div className="deal">
                <img src={dealOne} alt="Calgary deep dish pizza deal number 1" className="dealImg" />
            ...
            <div className="deal">
                <img src={banner} alt="Calgary deep dish pizza deal number 2" className="dealImg" />
                <div className="dealContent">
            ...
            <div className="deal">
                <img src={dealThree} alt="Calgary deep dish pizza deal number 3" className="dealImg" />
                <div className="dealContent">
            ...
            <div className="deal">
                <img src={banner} alt="Calgary deep dish pizza deal number 4" className="dealImg" />
                <div className="dealContent">
            ...
            <div className="deal">
                <img src={dealFive} alt="Calgary deep dish pizza deal number 5" className="dealImg" />
                <div className="dealContent">
            ...
            <div className="deal">
                <img src={dealSix} alt="Calgary deep dish pizza deal number 6" className="dealImg" />
                <div className="dealContent">
